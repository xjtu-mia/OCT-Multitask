...
from backbone.MPVIT import mpvit_small, mpvit_xsmall
...
class tinyquadra_multi_resUnet_ly_masks_s3(nn.Module):
    def __init__(self, in_ch, out_ch1, out_ch2, out_ch3, multitask=True, device='cuda', resize=None, branch_num=4):
        ...
        encoder = mpvit_small(in_ch=in_ch)
        '''pretext_model = torch.load(
            '/home/wanghualin/python_project/OCT/OCT_fluid_layer_seg/pytorch_ver/backbone/mpvit_small.pth')
        ...
        self.conv1 = encoder.stem[0:2]
        self.adp_conv1 = singleConv(64, 32, 1, act=False)
        self.pool1 = nn.MaxPool2d(2)
        #self.conv2 = encoder.layer1
        self.patch1 = encoder.patch_embed_stages[0]
        self.conv2 = encoder.mhca_stages[0]
        self.adp_conv2 = singleConv(128, 64, 1, act=False)
        #self.conv3 = encoder.layer2
        self.patch2 = encoder.patch_embed_stages[1]
        self.conv3 = encoder.mhca_stages[1]
        self.adp_conv3 = singleConv(216, 128, 1, act=False)
        #self.conv4 = encoder.layer3
        self.patch3 = encoder.patch_embed_stages[2]
        self.conv4 = encoder.mhca_stages[2]
        self.adp_conv4 = singleConv(288, 256, 1, act=False)
        #self.conv5 = encoder.layer4
        self.patch4 = encoder.patch_embed_stages[3]
        self.conv5 = encoder.mhca_stages[3]
        self.adp_conv5 = singleConv(288, 512, 1, act=False)
    ...
    def forward(self, x):
        ...
        #print(c1.shape)
        c2 = self.conv2(self.patch1(c1))
        adp_conv2 = self.adp_conv2(c2)
        #c2 = self.trans2(c2)
        c3 = self.conv3(self.patch2(c2))
        adp_conv3 = self.adp_conv3(c3)
        #c3 = self.trans3(c3)
        c4 = self.conv4(self.patch3(c3))
        adp_conv4 = self.adp_conv4(c4)

        #c4 = self.trans4(c4)
        c5 = self.conv5(self.patch4(c4))
        #c5 = self.trans5(c5)
        c5 = self.drop(c5)
