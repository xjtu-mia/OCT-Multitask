...
from backbone.preact_resnetv2 import PreActResNet50
import cv2
import numpy as np
...
class tinyquadra_multi_resUnet_ly_masks_s3(nn.Module):
    def __init__(self, in_ch, out_ch1, out_ch2, out_ch3, multitask=True, device='cuda',
                 resize=None, branch_num=4, use_RGM=True,use_IB=True):
