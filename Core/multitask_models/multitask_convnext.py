...
from backbone.convnxet import convnext_tiny
...
class tinyquadra_multi_resUnet_ly_masks_s3(nn.Module):
    def __init__(self, in_ch, out_ch1, out_ch2, out_ch3, multitask=False, device='cuda', resize=None):
        ...
        encoder = convnext_tiny(in_chans=32)
        '''print('loading pretrain weight...')
        pretext_model = torch.load(
            '/home/wanghualin/python_project/OCT/OCT_fluid_layer_seg/pytorch_ver/backbone/convnext_tiny_22k_1k_384.pth')
        ...
        self.conv1 = DoubleConv(in_ch, 32, 3)
        self.adp_conv1 = singleConv(64, 32, 1, act=False)
        self.pool1_ = encoder.downsample_layers[0]
        self.pool1 = nn.MaxPool2d(2)
        #self.conv2 = encoder.layer1
        self.conv2 = encoder.stages[0]
        self.adp_conv2 = singleConv(96, 64, 1, act=False)
        #self.conv3 = encoder.layer2
        self.pool2 = encoder.downsample_layers[1]
        self.conv3 = encoder.stages[1]
        self.adp_conv3 = singleConv(192, 128, 1, act=False)
        #self.conv4 = encoder.layer3
        self.pool3 = encoder.downsample_layers[2]
        self.conv4 = encoder.stages[2]
        self.adp_conv4 = singleConv(384, 256, 1, act=False)
        #self.conv5 = encoder.layer4
        self.pool4 = encoder.downsample_layers[3]
        self.conv5 = encoder.stages[3]
        self.adp_conv5 = singleConv(768, 512, 1, act=False)
...
if __name__ == '__main__':
    ...
    model = tinyquadra_multi_resUnet_ly_masks_s3(1,7,7,2, device='cpu')
